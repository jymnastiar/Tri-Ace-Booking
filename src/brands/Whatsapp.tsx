...
const SvgWhatsapp = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#fff"
      d="M12.5 9.5c-.333-.669-.844-.61-1.36-.61-.921 0-2.359 1.105-2.359 3.16 0 1.684.742 3.528 3.243 6.286 2.414 2.662 5.585 4.039 8.218 3.992s3.175-2.312 3.175-3.078c0-.339-.21-.508-.356-.554-.897-.43-2.552-1.233-2.928-1.384-.377-.15-.573.054-.695.165-.342.325-1.019 1.284-1.25 1.5s-.578.106-.721.025c-.53-.213-1.964-.85-3.107-1.96-1.415-1.37-1.498-1.842-1.764-2.262-.213-.335-.057-.541.021-.632.305-.351.726-.894.914-1.164s.04-.679-.05-.934c-.387-1.097-.715-2.015-.981-2.55"
    />
    <defs>
      <linearGradient
        id="whatsapp_svg__a"
